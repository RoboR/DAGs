...
if __name__ == '__main__':
    ...
    report_file = os.getcwd() + '/report_03 (copy).txt'
    ...
    FILTER_FAT_RATIO = "fat_2.0"
    FILTER_APPLICATION_NO = 4
    FILTER_PROCESSOR_NO = 4
    FILTER_DEADLINE_RATIO = 5

    title = "FAT RATIO : " + FILTER_FAT_RATIO + '\t' \
            "APPLICATION NO : " + str(FILTER_APPLICATION_NO) + '\t' \
            "PROCESSOR NO : " + str(FILTER_PROCESSOR_NO) + '\t' \
            "DEADLINE RATIO : " + str(FILTER_DEADLINE_RATIO)
    print(title)
    ...
    while True:
        ...
        if RESULT_DATA_REPRESENTATION[result_data_line_index] == 'HEADER_LINE':
            ...
            result = ""
            if currentResult.fat_ratio == FILTER_FAT_RATIO and \
               currentResult.application_no == FILTER_APPLICATION_NO and \
               currentResult.processor_no == FILTER_PROCESSOR_NO and \
               currentResult.deadline_ratio == FILTER_DEADLINE_RATIO:
